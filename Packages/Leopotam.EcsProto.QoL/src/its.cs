...
namespace Leopotam.EcsProto.QoL {
    ...
    [Il2CppSetOption (Option.ArrayBoundsChecks, false)]
        ...
        public sealed class ProtoItChainExc {
            ...
            public ProtoItExc End () => new ProtoItExc (_iTypes.ToArray (), _eTypes.ToArray ());
        }
    }
    ...
    public static class ProtoItExtensions {
        ...
        [MethodImpl (MethodImplOptions.AggressiveInlining)]
        public static ItEnumerator GetEnumerator (this ProtoIt it) => new (it);

        [MethodImpl (MethodImplOptions.AggressiveInlining)]
        public static ItEnumeratorExc GetEnumerator (this ProtoItExc it) => new (it);
